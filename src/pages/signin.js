...
function SignIn() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(patientLoginAction({ email, password }));
  };
  ...
  return (
    <div className="">
      <div
        className="h-screen md:h-full pt-12 md:py-28 pb-6 px-2 md:px-0 bg-tertiary md:border-4 border-light md:rounded-2xl md:m-10"
        style={{
            ...
            <div className="bg-white mx-auto max-w-lg p-8 md:p-12 mt-10 rounded-xl">
              <section className="header">
                <h3 className="font-bold flex flex-row text-gray-600 text-xl text-inline justify-center items-center">
                  Welcome to &nbsp;
                  <span className="text-tertiary text-xl md:text-3xl">
                    Heart-to-Heart
                  </span>
                  <svg
                    ...
                    className="feather feather-heart text-tertiary ml-2"
                  >
